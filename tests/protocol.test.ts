...
describe('Protocol', () => {
  ...
  describe('parse method', () => {
    ...
    describe('Simple commands', () => {
      ...
      it('should parse parameterless commands', () => {
        ...
        expect(protocol.parse('STATS')).toEqual({ type: 'STATS' } satisfies Command)
  ...
  describe('execute method', () => {
    describe('Main flows', () => {
      ...
      it('should execute STATS command', () => {
        const command: Command = { type: 'STATS' }
        const result = protocol.execute(command)
    ...
    describe('Failure cases', () => {
      it('should handle SET failure', () => {
        ...
        expect(result).toEqual({
          success: false,
          data: 'NOT_STORED',
          error: 'Failed to store (possibly too large)'
        } satisfies CommandResult)
      })
  ...
  describe('format method', () => {
    it('should format success responses', () => {
      const testCases: Array<{ input: CommandResult; expected: string }> = [
        { input: { success: true, data: 'STORED' }, expected: 'STORED' },
        { input: { success: true, data: 'cached_value' }, expected: 'cached_value' },
        { input: { success: true, data: null }, expected: 'NOT_FOUND' },
        { input: { success: true, data: 'YES' }, expected: 'YES' },
        { input: { success: true, data: 'key1;key2' }, expected: 'key1;key2' },
      ]
    ...
    it('should format QUIT response', () => {
      const result: CommandResult = { success: true, data: 'QUIT' }
      expect(protocol.format(result)).toBe('BYE')
    })
    ...
    it('should handle empty string data', () => {
      const result: CommandResult = { success: true, data: '' }
